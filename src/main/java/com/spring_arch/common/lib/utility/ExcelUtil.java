...
public class ExcelUtil {
    ...
    public int rowIndex, mergeStart, mergeEnd;
    // Row -> Column -> Pictures
    public Map<Integer, Map<Short, List<HSSFPictureData>>> pix = new HashMap<Integer, Map<Short, List<HSSFPictureData>>>();
     ...
     * @return 리턴 타입 (리턴이 없으면 생략)
     */
    public void table(final HSSFSheet sheet) {
